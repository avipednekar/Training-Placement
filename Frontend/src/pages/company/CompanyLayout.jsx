...
const CompanyLayout = () => {
    ...
    const menuItems = [
        { path: '/company/dashboard', icon: 'ri-dashboard-line', label: 'Dashboard' },
        { path: '/company/post-job', icon: 'ri-add-circle-line', label: 'Post New Job' },
        { path: '/company/jobs', icon: 'ri-briefcase-line', label: 'Manage Jobs' },
        { path: '/company/applicants', icon: 'ri-group-line', label: 'Applicants' },
    ];
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
                ...
                <div className="p-6 border-b border-gray-100 text-center">
                    ...
                    <h3 className="font-semibold text-gray-800">{user?.name || 'Company'}</h3>
